...
!function() {
    ...
    var a = $("#footer-2013 a[href='http://about.58.com/fqz/spe.ftl']");
...
!function() {
    ...
    a.jdCalcul = function(b) {
        var c = null, b = b.join(","), d = "http://qiang.jd.com/HomePageNewLimitBuy.ashx?callback=?&ids=" + b, e = "http://item11.jd.com/", f = function(b) {
...
var category = {OBJ: $("#_JD_ALLSORT"),
		...
		URL_Serv: "http://localhost:8080/category/findAllCatesForPortal",
